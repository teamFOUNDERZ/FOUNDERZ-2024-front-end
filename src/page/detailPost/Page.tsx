...
export default function DetailPost() {
  ...
  const businessId = "yourBusinessId"; // 실제 사용할 businessId로 대체
  ...
  useEffect(() => {
    const fetchBusinessData = async () => {
      try {
        ...
        console.error("사업 아이템 상세 조회 실패:", error);
      }
    };
  ...
  if (!businessDetails) {
    return <div><p style={{ ...Fonts["TitleLarge"], color: Colors.Blue500 }}>로딩 중...</p></div>;
  }
    ...
    <Main>
      <Content>
        <Title>
          ...
          <p style={{ ...Fonts["BodyLarge"], color: Colors.Gray600 }}>
            {businessDetails.one_line_introduction}
          </p>
          <Tag>#금융</Tag>
        </Title>
        <BoxContainer>
        ...
        <Overview>
          <p style={{ ...Fonts["TitleSmall"], color: Colors.Black }}>II. 기업 개요</p>
          <p style={{ ...Fonts["TitleTiny"], color: Colors.Black, marginLeft: "24px" }}>1. 개요</p>
          <p style={{ ...Fonts["BodySmall"], color: Colors.Black, marginLeft: "48px" }}>
            {businessDetails.business_introduction}
          </p>
          <p style={{ ...Fonts["TitleTiny"], color: Colors.Black, marginLeft: "24px" }}>2. 투자유치 현황</p>
          <p style={{ ...Fonts["BodySmall"], color: Colors.Black, marginLeft: "48px" }}>
            {businessDetails.write_purpose}
          </p>
        </Overview>
        <Line />
        <Invest>
          <p style={{ ...Fonts["BodyMedium"], color: Colors.Gray600 }}>총 투자금</p>
          <p style={{ ...Fonts["TitleLarge"], color: Colors.Blue500 }}>
            {businessDetails.investment_amount.toLocaleString()} <span>원</span>
          </p>
        </Invest>
        <InvestBox>
          <p style={{ ...Fonts["TitleSmall"], color: Colors.Black }}>사업아이템이 마음에 드셨나요?</p>
